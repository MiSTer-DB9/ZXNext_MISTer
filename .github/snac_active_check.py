...
#
# Enforces .claude/rules/hazards/snac-priority.md. The joydb wrapper
...
# Per-core SNAC-enable RHS, verbatim from snac-priority.md. The value is
...
def analyze(core_name, core_sv):
    ...
    if tabled and is_default:
        ...
        issues.append((
            ...
            f"review + add to snac-priority.md / SNAC_CORES"))
    return issues, rhs
